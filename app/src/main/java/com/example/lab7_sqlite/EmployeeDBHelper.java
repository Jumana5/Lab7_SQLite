...
public class EmployeeDBHelper {
    ...
    private static final int databaseversion = 1; // If you change the database schema, you must increment the database version.
    private static final String create_table = "create table Employee (EmpId integer " +
            "primary key autoincrement, " + "EmpName text not null, EmpSal integer not null);";
    private final Context ct;
    private DatabaseHelper dbHelper;
    private SQLiteDatabase database; // to use execSQL()
    ...
    public Cursor retrieveAllEmployees() {
        this.connect();
        return database.query(tablename, new String[] { EmpId, EmpName,
                EmpSal}, null,null, null, null, null);
    }
    ...
    public Cursor retrieveEmployee(long id) throws SQLException {
        this.connect();
        Cursor c = database.query(true, tablename, new String [] {EmpId, EmpName, EmpSal}, EmpId + "=" + id, null, null, null, null, null);
